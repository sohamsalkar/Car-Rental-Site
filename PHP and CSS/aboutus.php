...
$id=$_SESSION["username"];
 ...
 $s = mysqli_fetch_array($r);
    ...
    <div class="container-bkimg">
        <img src="images/aboutus-page-header-img.jpg"  style="width:100%;height:250px;opacity:0.5;border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
    ...
    <div style="background-color:#cdf9ff;padding:50px;margin-left: 112px;">
        ...
        <div class="container">
            <p>About Car Rental: Car Rental is a global leader in online car booking, with own branches and franchisee across India. This has a proven partner focused network of online car rental services. which has enabled clients in more than 99+ cities to avail our car hire services. This has made us outperform the competition and stay ahead of the innovative services.
            ...
            Car Rental has a growing country wide presence with more than 97+ cities network. And also to serve its clients at one single point all cab booking services.
            At Car Rental, we believe our responsibilities and also extend beyond business.
            So that’s why we have established strong customer relationship which makes our clients to use our services repeatedly.
            At Car Rental, Chauffeurs are Polite, highly efficient, well-mannered, English speaking, Experience in handling corporates. And also foreign clients, dressed in Uniforms, black shoes and carry a mobile.
            Car Rental known for, PAN India car rental services round the clock, 29 years experience. And also Airport transfers expertise and Chauffeur courteous. Car Rental services, cheap rental car, Hybrid rental car. All the cars seats well equipped with comfortable cushions, Mobile recharger, tissue paper box, reading light.
            Car Rental provides standard size cars as well as large cars according to your choice and also for all make of cars as per your budget.
            Travelocar has overcome ubiquitous problem in India for the people to get a good quality car at affordable rates for their outstation or full day city travel plans.</p> 
        </div>
        </center>
        </div>
    </div>
